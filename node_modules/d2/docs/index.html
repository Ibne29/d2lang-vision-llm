...
<div id="main">
    ...
    <section class="readme">
        <article><h1>d2</h1>
<p><a href="https://travis-ci.com/dhis2/d2"><img src="https://travis-ci.com/dhis2/d2.svg?branch=master" alt="build status"></a>
<a href="https://greenkeeper.io/"><img src="https://badges.greenkeeper.io/dhis2/d2.svg" alt="greenkeeper badge"></a>
<a href="https://badge.fury.io/js/d2"><img src="https://badge.fury.io/js/d2.svg" alt="npm version"></a></p>
<p>The full api documentation is available <a href="https://d2-ci.github.io/d2/">here</a>. To get started we suggest you read the <a href="https://d2-ci.github.io/d2/tutorial-overview.html">overview</a>. If you already know what you're looking for we suggest the reference material on what is available on the instance of <a href="https://d2-ci.github.io/d2/module-d2.init-d2.html">d2</a>.</p>
<p>For more information on how the models work the <a href="https://d2-ci.github.io/d2/module-model.html">model module documentation</a> is helpful reference material. For other questions see the <a href="https://d2-ci.github.io/d2/tutorial-FAQ.html">FAQ</a>.</p>
<h2>Quickstart guide</h2>
<h3>Install</h3>
<p>Start with adding d2 to your project:</p>
...
<h3>Initialise the library</h3>
<p>To be able to use d2 you will first need to initialise the library. This is required to let the library know where it should load its data from (e.g. the schemas, currentUser, authorities). The schemas are the definitions of the data model as used in DHIS2.</p>
<p>To do this you can provide d2 with a <code>baseUrl</code> (if you don't provide any the default of <code>../api</code> will be used):</p>
...
<h3>Get first page of users and print their names</h3>
<pre class="prettyprint source lang-js"><code>d2.models.user.list()
  .then(userCollection => {
    userCollection.forEach(user => console.log(user.name)));
  });
</code></pre>
<p>That's it! See the documentation referenced above for further information.</p>
<h2>Report an issue</h2>
<p>The issue tracker can be found in <a href="https://jira.dhis2.org">DHIS2 JIRA</a>
under the <a href="https://jira.dhis2.org/projects/LIBS">LIBS</a> project.</p>
<p>Deep links:</p>
<ul>
<li><a href="https://jira.dhis2.org/secure/CreateIssueDetails!init.jspa?pid=10700&amp;issuetype=10006&amp;components=11011">Bug</a></li>
<li><a href="https://jira.dhis2.org/secure/CreateIssueDetails!init.jspa?pid=10700&amp;issuetype=10300&amp;components=11011">Feature</a></li>
<li><a href="https://jira.dhis2.org/secure/CreateIssueDetails!init.jspa?pid=10700&amp;issuetype=10003&amp;components=11011">Task</a></li>
</ul></article>
    </section>
