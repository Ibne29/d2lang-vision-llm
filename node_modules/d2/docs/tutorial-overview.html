...
<article>
    <h2>D2</h2>
<p>The d2 library is a javascript library that abstracts away the dhis2 api and lets you use javascript models to communicate with your dhis2 server.</p>
...
<li>me (currentUser) (<a href="module-current-user.CurrentUser.html">CurrentUser</a>)
<ul>
...
<p>d2 requires an initialisation step to be able to use some the functionality. To initialise
...
<p>We import the <a href="module-d2.html#.init">init</a> function from the d2 library and call it with a config object.</p>
...
<h2>The d2 object and <code>getInstance</code></h2>
<p>During the initialisation the <a href="module-d2.init-d2.html">d2</a> object is created. The <a href="module-d2.html#.init">init</a> function returns a promise
...
<p>For a more elaborate description on whats available on the d2 object see the <a href="module-d2.init-d2.html">d2 namespace</a></p>
</article>
